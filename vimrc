...
" Smart indentation can cause some problems. See:
" http://stackoverflow.com/a/2360284
"
" set smartindent 
"
set tabstop=4 
...
"==============================================================================
" PYTHON macros and bindings
"============================
"
" ipdb
nnoremap <silent> <F5> oimport ipdb<CR>ipdb.set_trace()<Esc>:w<CR>
map! <silent> <F5> <Esc>oimport ipdb<CR>ipdb.set_trace()<Esc>:w<CR>
" try with ipdb
nnoremap <silent> <F6> Otry:<Esc>jI<tab><Esc>oexcept:<Esc>oimport ipdb<CR>ipdb.set_trace()<Esc>:w<CR>
map! <silent> <F6> <Esc>oimport ipdb<CR>ipdb.set_trace()<Esc>:w<CR>
"
" folding
nnoremap <space> za
vnoremap <space> zf
"
" Red line indicating endline for python
...
"
"===================================
" end of PYTHON macros and bindings
"==============================================================================


"==============================================================================
" SAVING utility (ctrl+s)
"=========================
